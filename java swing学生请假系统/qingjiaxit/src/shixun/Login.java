...
//		    imagelabel.setBounds(0,0,800,550);
			...
			jrb1.setBounds(150,320,70,30);
			jrb2.setBounds(220,320,70,30);
			jrb3.setBounds(290,320,100,30);
			jrb4.setBounds(390,320,100,30);
			jrb5.setBounds(490,320,100,30);
...
//			  if(account.compareTo("root")!=0||account.compareTo("root4")!=0 ){	
//				
//				if(pwd.compareTo("root")!=0||pwd.compareTo("root4")!=0){
//					fieldAccount.setText("账号或密码错误");
//				}
//				
//			  
...
//		if(account.compareTo("root")!=0&&pwd.compareTo("root")!=0){
