...
public class WaimaidingdanController {
    ...
    public R page(@RequestParam Map<String, Object> params,WaimaidingdanEntity waimaidingdan, 
		...
		if(tableName.equals("yonghu")) {
			waimaidingdan.setZhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("qishou")) {
			waimaidingdan.setQishouzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        if(tableName.equals("qishou")) {
            ew.eq("qishouzhanghao", (String)request.getSession().getAttribute("username"));
        }
